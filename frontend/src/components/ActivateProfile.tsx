                ...
                <Modal isOpen={unlockKey === ""} onClose={() => {
                    ...
                    <ModalContent>
                        ...
                        <ModalBody>
                            ...
                            <Box height={2} />
                            <p>Ingresa tu correo electrónico{method === "both" && " o los úlimos 6 dígitos del celular registrado"}:</p>
                ...
                {userProfile && (
                    <>
                        <Alert status="warning" mb={4}>
                            <AlertIcon />
                            <Box>
                                <Text fontWeight="bold">Atención:</Text>
                                Los datos ingresados no podrán ser modificados posteriormente. Por favor, revisa que la información sea correcta antes de guardar.
                            </Box>
                        </Alert>
